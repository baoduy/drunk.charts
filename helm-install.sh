...
#helm install cloudflare-tunnels cloudflare-tunnels-1.0.0.tgz --namespace default -f cloudflare-tunnels/values.yaml --set secretProviderClass.create=false --dry-run
