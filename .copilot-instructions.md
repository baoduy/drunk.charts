...
├── values.example.yaml    # Test-specific values (for drunk-app)
...
- Value files: `values.yaml`, `values.example.yaml`
...
helm template test-release ./ --values values.example.yaml
