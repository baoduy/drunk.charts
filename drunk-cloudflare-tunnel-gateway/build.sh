#!/bin/bash
# Build script for drunk-cloudflare-tunnel-gateway chart
...
echo -e "${BLUE}Building drunk-cloudflare-tunnel-gateway chart...${NC}"
cd "$CHART_DIR"
...
# Update dependencies (pulls cloudflare-tunnel-gateway-controller from oci://ghcr.io/lexfrei/charts)
...
helm repo index . --url https://baoduy.github.io/drunk.charts/drunk-cloudflare-tunnel-gateway
