#!/bin/bash
# Install script for drunk-cloudflare-tunnel-gateway chart
# Two-phase installation:
#  1. Install Gateway API CRDs via kubectl (bypasses Helm 3MB annotation limit)
#  2. Install Helm chart for GatewayClass, Gateway, HTTPRoute, cloudflare-tunnel-gateway-controller
#
# Usage (basic):
...
#   VALUES_FILE=values.example.yaml         # Values file
...
echo ""
info "========================================="
info "drunk-cloudflare-tunnel-gateway Installation"
info "========================================="
...
echo ""
info "Phase 2: Installing Helm chart (GatewayClass, Gateway, HTTPRoute, cloudflare-tunnel-gateway-controller)"
...
echo "  kubectl get gatewayclass cloudflare-tunnel"
echo "  kubectl get gateway -n $NAMESPACE"
echo "  kubectl get pods -n $NAMESPACE -l app.kubernetes.io/name=cloudflare-tunnel-gateway-controller"
echo ""
