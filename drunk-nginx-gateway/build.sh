#!/bin/bash
# Build script for drunk-nginx-gateway chart
...
echo -e "${BLUE}Building drunk-nginx-gateway chart...${NC}"
cd "$CHART_DIR"
...
# Update dependencies (pulls nginx-gateway-fabric from oci://ghcr.io/nginx/charts)
...
helm repo index . --url https://baoduy.github.io/drunk.charts/drunk-nginx-gateway
